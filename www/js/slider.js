...
(function($){
	...
	$.movingBoxes.defaultOptions = {
		...
		width        : 1600,       // overall width of movingBoxes
		panelWidth   : 5,       // current panel width adjusted to 50% of overall width
		reducedSize  : 0.2,       // non-current panel size: 80% of panel size
